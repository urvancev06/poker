// The card decks: their palettes, face layouts and backs. Every deck draws on
// the same 100x140 viewBox, so decks are interchangeable at any card size.
// Kept out of prefs.tsx so that file exports only its provider component
// (Fast Refresh needs component-only modules).
